    ...
    return (
        <div className="h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 relative pt-20 pb-6 px-4 transition-colors duration-500 overflow-hidden">
            ...
            <motion.div
                ...
                className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl shadow-2xl dark:shadow-sky-950/30 border border-slate-200/80 dark:border-slate-800 relative z-10 flex flex-col lg:flex-row w-full max-w-4xl max-h-[calc(100vh-6rem)] overflow-hidden rounded-2xl md:rounded-3xl"
            >
                {/* Left Form Column */}
                <div className="p-6 md:p-10 w-full lg:w-[500px] shrink-0 relative flex flex-col justify-between overflow-y-auto max-h-[calc(100vh-7rem)]">
                    <div>
                        <Link
                            to={ROUTES.HOME}
                        ...
                        <div className="flex flex-col items-center text-center mb-8">
                            ...
                            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 font-normal">
                                Accédez à votre tableau de bord Academia Connect
                            </p>
                        </div>

                        <GoogleLoginButton label="Se connecter avec Google" onError={(err) => setError(err)} />
                        ...
                        <form className="space-y-4" onSubmit={handleSubmit}>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-10 py-2.5 bg-slate-50 dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700/80 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-xs transition-all rounded-xl"
                                        placeholder="••••••••"
                                        required
                                    />
                                    <button
                                        ...
                                        className="absolute inset-y-0 right-0 pr-3.5 flex items-center text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 transition-colors"
                                    >
                            ...
                            <div className="flex items-center justify-between text-xs pt-1">
                                <label className="flex items-center text-slate-600 dark:text-slate-400 cursor-pointer select-none">
                                    <input
                                        type="checkbox"
                                        className="mr-2 text-sky-600 focus:ring-sky-500 rounded border-slate-300 dark:border-slate-700 dark:bg-slate-800"
                                    />
                                    Se souvenir de moi
                                </label>
                                <Link
                        ...
                        <p className="text-center text-slate-500 dark:text-slate-400 text-xs pt-4">
                            Pas encore de compte ?{' '}
                            <Link to={ROUTES.REGISTER} className="text-sky-600 dark:text-sky-400 font-bold hover:underline">
                                S'inscrire
                            </Link>
                        </p>
                    </div>
