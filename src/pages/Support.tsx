...
import {
    ...
    ChevronRight, PlayCircle, CheckCircle, ArrowRight, Briefcase, Building,
...
const Support: React.FC = () => {
    ...
    const render_getting_started = () => (
        <div className='animate-in fade-in transition-all duration-700'>
            <div className="mb-10 text-center">
                <h1 className="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-indigo-800 tracking-tight leading-tight py-2">📚 NB-MIND School : Manuel d'Utilisation Intégral (2026)</h1>
                <div className="h-2 w-32 bg-blue-600 rounded-full mx-auto mt-6 mb-8"></div>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">🌟 Vision du Produit</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">📂 Organisation du manuel</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
    ...
    const render_pdg = () => (
        <div className='animate-in fade-in transition-all duration-700'>
            <div className="mb-10 text-center">
                <h1 className="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-indigo-800 tracking-tight leading-tight py-2">👔 GUIDE FONCTIONNEL : Le Profil PDG (Multi-Écoles)</h1>
                <div className="h-2 w-32 bg-blue-600 rounded-full mx-auto mt-6 mb-8"></div>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">📈 1. Tableau de bord stratégique (Global Stats)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
                Le module **Global Stats** (accessible sur Web/Desktop) offre une vue consolidée de l'ensemble de l'écosystème Evenia.
            </p>
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">📊 1.1 Indicateurs de Performance (KPI)</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">🏗️ 2. Créer une École ou un Établissement (Pas à Pas)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">➕ Procédure de création d'un nouveau site :</h3>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">🏫 Suivi des Détails de l'Ecole (School Details)</h3>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">💰 3. Gestion Financière & Abonnements (Finance)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">💸 3.1 Encaissements Globaux</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">💳 3.2 Renouveler son Abonnement (Pas à Pas)</h3>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">🔒 4. Administration & Sécurité (Settings)</h2>
            </div>
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">⚙️ 4.1 Variables Globales</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">🚀 5. Avantages du Support Desktop pour le PDG</h2>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
    ...
    const render_direction = () => (
        <div className='animate-in fade-in transition-all duration-700'>
            <div className="mb-10 text-center">
                <h1 className="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-indigo-800 tracking-tight leading-tight py-2">🏛️ GUIDE FONCTIONNEL : Le Profil Provisoriat/Direction</h1>
                <div className="h-2 w-32 bg-blue-600 rounded-full mx-auto mt-6 mb-8"></div>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">📅 1. Configuration Annuelle et Cycles (Cycles)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">🔄 1.1 Définition des Cycles</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">🏫 2. Gestion des Classes et des Salles (Classes & Rooms)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">🗂️ 2.1 Création des Classes</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">🚪 2.2 Salles de Classe (Rooms)</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">👮 3. Gestion du Personnel (Staff & Teachers)</h2>
            </div>
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">👨‍🏫 3.1 Corps Enseignant (Teachers)</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">👷 3.2 Personnel Administratif (Staff)</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">🗓️ 4. Emploi du Temps Intelligent (Schedule)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">🛠️ 4.1 Génération de l'Emploi du Temps</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">📢 5. Communication et Annonces (Announcements)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">📑 6. Validation des Résultats & Bulletins (Report Cards)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">🌐 7. Avantages Desktop pour la Direction</h2>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
    ...
    const render_secretariat = () => (
        <div className='animate-in fade-in transition-all duration-700'>
            <div className="mb-10 text-center">
                <h1 className="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-indigo-800 tracking-tight leading-tight py-2">📝 GUIDE FONCTIONNEL : Le Profil Secrétariat & Admission</h1>
                <div className="h-2 w-32 bg-blue-600 rounded-full mx-auto mt-6 mb-8"></div>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">🎒 1. Processus d'Inscription (Enrollment)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">📝 1.1 Inscription individuelle</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">🍱 1.2 Inscription Massive (Bulk Import)</h3>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">📂 2. Gestion du Dossier Éélève (Students)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">🔍 2.1 Fiche Éélève détaillée</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">🏷️ 2.2 Re-inscription Annuelle</h3>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">📑 3. Génération de Documents Administratifs (Reports)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">⏱️ 4. Suivi d'Assiduité (Attendance Admin)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">👩‍💻 5. Usage de l'application Desktop pour le Secrétariat</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
    ...
    const render_teachers = () => (
        <div className='animate-in fade-in transition-all duration-700'>
            <div className="mb-10 text-center">
                <h1 className="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-indigo-800 tracking-tight leading-tight py-2">👨‍🏫 GUIDE FONCTIONNEL : Le Profil Enseignant (Expertise Pédagogique)</h1>
                <div className="h-2 w-32 bg-blue-600 rounded-full mx-auto mt-6 mb-8"></div>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">🗂️ 1. Organisation Hebdomadaire (My Schedule)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">🕰️ 1.1 Emploi du Temps personnel</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">⏱️ 2. Gestion de l'Assiduité (Attendance)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">📝 2.1 Appel Numérique</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">📒 3. Cahier de Texte et Progression (Books)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">🖊️ 3.1 Contenu de la Séance</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">🎒 3.2 Gestion des Devoirs (Homework)</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">📊 4. Évaluation et Saisie des Notes (Grades)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">📝 4.1 Carnet de Notes Numérique</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">📈 4.2 Calcul des Moyennes</h3>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">👨‍💻 5. Pourquoi privilégier l'application Desktop pour l'Enseignant ?</h2>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
    ...
    const render_parents = () => (
        <div className='animate-in fade-in transition-all duration-700'>
            <div className="mb-10 text-center">
                <h1 className="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-indigo-800 tracking-tight leading-tight py-2">📱 GUIDE FONCTIONNEL : Le Profil Parent & Élève (Usage Mobile)</h1>
                <div className="h-2 w-32 bg-blue-600 rounded-full mx-auto mt-6 mb-8"></div>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">👨‍👩‍👧 1. Profil Parent : Suivi Scolaire à Distance</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">🏠 1.1 Tableau de Bord Enfant</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">📉 2. Résultats Académiques (Scores & Bulletins)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">📊 2.1 Notes et Évaluations</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">📑 2.2 Téléchargement des Bulletins (Report Cards)</h3>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">⏱️ 3. Assiduité et Ponctualité (Attendance & Absences)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">📝 3.1 Registre des Absences et Retards</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">🎒 4. Profil Élève : Agenda et Devoirs (Homework)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">🗓️ 4.1 Emploi du Temps et Salles</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">📒 4.2 Cahier de Texte et Travaux à rendre</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">💰 5. Suivi Financier (Finances & Scolarité)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">💬 6. Messagerie et Notifications (Messages)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
    ...
    const render_troubleshooting = () => (
        <div className='animate-in fade-in transition-all duration-700'>
            <div className="mb-10 text-center">
                <h1 className="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-indigo-800 tracking-tight leading-tight py-2">🛠️ GUIDE FONCTIONNEL : Guide Technique & Maintenance</h1>
                <div className="h-2 w-32 bg-blue-600 rounded-full mx-auto mt-6 mb-8"></div>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">💻 1. Installation et Mises à Jour (Setup)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">🌐 1.1 Accès Web</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">🖥️ 1.2 Application Desktop (Recommandé)</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">📱 1.3 Application Mobile</h3>
            </div>
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} className="mb-4 pl-4 hover:pl-6 transition-all duration-300">
                <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                    <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500"><ArrowRight className="w-4 h-4" /></div>
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">🐛 2. Dépannage Courant (Troubleshooting)</h2>
            </div>
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">⚠️ 2.1 Problèmes de Lancement (Spécial Linux/Wayland)</h3>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">🧹 2.2 Vidage du Cache et Réinitialisation</h3>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">💾 3. Sauvegardes et Sécurité (Backup)</h2>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
            ...
            <div className="mt-16 mb-8 relative">
                <div className="absolute -left-6 top-2 bottom-0 w-2 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-lg"></div>
                <h2 className="text-3xl font-extrabold text-slate-800 pl-4">📞 4. Support Technique NB-MIND School</h2>
            </div>
            <div className="mt-10 mb-6 flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center font-bold text-blue-700"><CheckCircle className="w-6 h-6" /></div>
                <h3 className="text-2xl font-bold text-blue-900">Comment signaler un bug ?</h3>
            </div>
            <p className="text-xl text-slate-500 mb-8 leading-loose font-medium">
    ...
    return (
        <div className="min-h-screen bg-slate-50 font-sans pb-32">
            <header className="relative bg-[#0A192F] pt-40 pb-32 overflow-hidden shadow-2xl">
                <div className="absolute inset-0 z-0">
                    <div className="absolute top-10 left-10 w-96 h-96 bg-blue-600/20 rounded-full blur-[120px] mix-blend-screen animate-pulse"></div>
                    <div className="absolute bottom-10 right-10 w-[500px] h-[500px] bg-indigo-500/20 rounded-full blur-[150px] mix-blend-screen animate-pulse"></div>
                </div>

                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="text-center max-w-4xl mx-auto">
                        <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-blue-500/10 border border-blue-400/20 text-blue-300 font-semibold tracking-wide uppercase text-sm mb-10 backdrop-blur-sm shadow-lg">
                        ...
                        <div className="relative max-w-2xl mx-auto mt-10">
                            <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-3xl blur opacity-25"></div>
                            <div className="relative flex items-center bg-[#112240] border border-blue-800/50 rounded-3xl shadow-2xl p-2">
                                <Search className="w-7 h-7 ml-6 text-blue-400" />
                                <input type="text" placeholder="Rechercher une fonctionnalité..." className="w-full bg-transparent border-none text-white text-xl p-6 focus:outline-none" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-20">
                <div className="flex flex-col xl:flex-row gap-10">
                    <aside className="xl:w-1/3 2xl:w-[400px] shrink-0 sticky top-4 z-30 xl:relative xl:top-0">
                        <div className="bg-white/90 backdrop-blur-md rounded-[24px] md:rounded-[32px] shadow-xl p-3 md:p-6 border border-slate-100 shadow-blue-500/5">
                            <nav className="flex xl:flex-col overflow-x-auto xl:overflow-x-visible gap-3 pb-4 xl:pb-0 scrollbar-hide">
                                {menuItems.map((item) => {
                                    const Icon = item.icon;
                                    return (
                                        <button key={item.id} onClick={() => setActiveTab(item.id)}
                                            className={`flex-shrink-0 xl:w-full group flex items-start gap-4 p-4 md:p-5 rounded-[24px] font-bold transition-all ${activeTab === item.id ? 'bg-blue-600 text-white shadow-xl scale-[1.02]' : 'text-slate-700 bg-white border border-slate-100 hover:bg-slate-50'}`}>
                    ...
                    <main className="flex-1 min-w-0">
                        <AnimatePresence mode="wait">
                            <motion.div key={activeTab} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }}
                                className="bg-white rounded-[40px] shadow-2xl p-8 md:p-16 border border-slate-100 relative">
                                ...
                                <div className="mt-32 pt-16 border-t-[3px] border-dashed border-slate-100 text-center">
                                    <h2 className="text-4xl font-black text-slate-800 mb-6">FAQ & Support Technique</h2>
                                    <p className="text-xl text-slate-500 mb-10">Notre documentation couvre l'intégralité des flux de travail.</p>
