...
const Finances = () => {
    ...
    return (
        <div className="p-8 max-w-7xl mx-auto min-h-screen space-y-8 animate-in fade-in zoom-in-95 duration-500">
            {/* Header */}
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <h1 className="text-4xl font-black text-slate-800 tracking-tight">Finances & Analyses</h1>
                    <p className="text-slate-500 font-medium mt-2">Analysez les revenus et paiements de votre école</p>
                </div>
            </div>
            ...
            {!loading && stats && (
                <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="bg-white p-8 shadow-xl shadow-slate-200/50 border-l-4 border-blue-500 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
                        ...
                        <div className="bg-white p-8 shadow-xl shadow-slate-200/50 border-l-4 border-emerald-500 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
                        ...
                        <div className="bg-white p-8 shadow-xl shadow-slate-200/50 border-l-4 border-red-500 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white p-8 shadow-xl shadow-slate-200/50 lg:col-span-2">
