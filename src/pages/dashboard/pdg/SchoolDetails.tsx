...
const SchoolDetails: React.FC = () => {
    ...
    const [activeTab, setActiveTab] = useState<'overview' | 'staff' | 'cycles'>('overview');
    ...
    return (
        <>
            ...
            <div className="relative mb-10">
                ...
                <div className="bg-white rounded-[40px] p-10 shadow-xl shadow-slate-200/40 border border-slate-100 flex flex-col md:flex-row items-center gap-10">
                    <div className="w-32 h-32 rounded-[32px] overflow-hidden bg-slate-50 border-4 border-slate-50 shadow-inner flex-shrink-0">
                        {institution.logoUrl ? (
                    ...
                    <div className="flex-1 text-center md:text-left">
                        <div className="flex flex-col md:flex-row md:items-center gap-4 mb-2">
                            ...
                            <span className="px-4 py-1.5 bg-indigo-50 text-indigo-600 rounded-full text-[10px] font-black uppercase tracking-widest self-center md:self-auto">
                                {institution.type}
                            </span>
                        </div>
                    ...
                    <div className="flex gap-4">
                        <button
                            ...
                            className="p-4 bg-red-50 text-red-600 rounded-2xl hover:bg-red-600 hover:text-white transition-all shadow-lg shadow-red-500/10 flex items-center gap-2 font-black text-sm"
                            title="Supprimer l'établissement"
                        >
                            <Trash2 size={20} />
                            <span className="hidden md:inline">Supprimer</span>
                        </button>
                        <div className={`px-6 py-3 rounded-2xl font-black text-sm flex items-center ${institution.active ? 'bg-emerald-50 text-emerald-600' : 'bg-amber-50 text-amber-600'}`}>
            ...
            <div className="flex gap-2 mb-10 overflow-x-auto pb-2 scrollbar-none">
                {[
                    ...
                    <button
                        ...
                        className={`flex items-center gap-3 px-8 py-4 rounded-[20px] font-black transition-all whitespace-nowrap ${activeTab === tab.id
            ...
            <AnimatePresence mode="wait">
                {activeTab === 'overview' && (
                    ...
                    >
                        <div className="bg-white rounded-[32px] p-10 border border-slate-100 shadow-lg">
                    ...
                    >
                        <div className="flex justify-between items-center mb-10">
                            ...
                            <button
                                ...
                                className="bg-indigo-600 text-white px-6 py-3 rounded-2xl font-black flex items-center gap-2 hover:scale-105 transition-all shadow-lg shadow-indigo-600/20"
                            >
                        ...
                        <div className="mb-16">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                ...
                                {(() => {
                                    ...
                                    if (mainAdmin) {
                                        return (
                                            <div className="bg-white rounded-[40px] p-8 border border-slate-100 shadow-xl relative overflow-hidden group">
                                                <div className="absolute top-0 right-0 w-40 h-40 bg-indigo-500/5 rounded-full -mr-16 -mt-16 transition-all group-hover:scale-110"></div>
                                                <div className="flex justify-between items-start mb-8 relative">
                                                    <div className="w-20 h-20 rounded-[28px] bg-indigo-600 text-white flex items-center justify-center shadow-2xl shadow-indigo-600/20 group-hover:rotate-6 transition-transform">
                                                        <Shield size={40} />
                                                    </div>
                                                    <div className="flex gap-2">
                                                        <button onClick={() => setEditingStaff(mainAdmin)} className="p-3 bg-slate-50 text-slate-400 rounded-xl hover:bg-indigo-50 hover:text-indigo-600 transition-all shadow-sm"><Info size={20} /></button>
                                                        <button onClick={() => setShowDeleteStaffModal({ isOpen: true, staffId: mainAdmin.id })} className="p-3 bg-slate-50 text-slate-400 rounded-xl hover:bg-red-50 hover:text-red-500 transition-all shadow-sm"><Trash2 size={20} /></button>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="flex flex-col gap-3 mt-8">
                                                    <div className="flex items-center gap-3 text-slate-500 font-bold text-sm bg-slate-50 p-4 rounded-2xl border border-slate-100/50">
                                    ...
                                    return (
                                        <div className="bg-slate-50/50 rounded-[40px] p-10 border-2 border-dashed border-slate-200 flex flex-col items-center justify-center text-slate-400 min-h-[300px] group hover:border-indigo-300 hover:bg-white transition-all overflow-hidden lg:col-span-1">
                                            <div className="w-20 h-20 rounded-3xl bg-white border border-slate-100 shadow-sm flex items-center justify-center mb-6 text-slate-300 group-hover:text-indigo-300 group-hover:scale-110 transition-all">
                                                <Shield size={32} />
                                            </div>
                                ...
                                {(() => {
                                    ...
                                    if (secretary) {
                                        return (
                                            <div className="bg-white rounded-[40px] p-8 border border-slate-100 shadow-xl relative overflow-hidden group">
                                                <div className="absolute top-0 right-0 w-40 h-40 bg-emerald-500/5 rounded-full -mr-16 -mt-16 transition-all group-hover:scale-110"></div>
                                                <div className="flex justify-between items-start mb-8 relative">
                                                    <div className="w-20 h-20 rounded-[28px] bg-emerald-500 text-white flex items-center justify-center shadow-2xl shadow-emerald-500/20 group-hover:rotate-6 transition-transform">
                                                        <UserCircle size={40} />
                                                    </div>
                                                    <div className="flex gap-2">
                                                        <button onClick={() => setEditingStaff(secretary)} className="p-3 bg-slate-50 text-slate-400 rounded-xl hover:bg-emerald-50 hover:text-emerald-600 transition-all shadow-sm"><Info size={20} /></button>
                                                        <button onClick={() => setShowDeleteStaffModal({ isOpen: true, staffId: secretary.id })} className="p-3 bg-slate-50 text-slate-400 rounded-xl hover:bg-red-50 hover:text-red-500 transition-all shadow-sm"><Trash2 size={20} /></button>
                                                    </div>
                                                </div>
                                    ...
                                    return (
                                        <div className="bg-slate-50/50 rounded-[40px] p-10 border-2 border-dashed border-slate-200 flex flex-col items-center justify-center text-slate-400 min-h-[300px] group hover:border-emerald-300 hover:bg-white transition-all overflow-hidden lg:col-span-1">
                                            <div className="w-20 h-20 rounded-3xl bg-white border border-slate-100 shadow-sm flex items-center justify-center mb-6 text-slate-300 group-hover:text-emerald-300 group-hover:scale-110 transition-all">
                                                <UserCircle size={32} />
                                            </div>
                        ...
                        <div className="mt-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <motion.button
                                    ...
                                    className="bg-white rounded-[40px] p-10 border border-slate-100 shadow-xl flex items-center gap-8 text-left hover:border-indigo-200 transition-all group relative overflow-hidden"
                                >
                                    <div className="absolute top-0 right-0 w-40 h-40 bg-slate-900/5 rounded-full -mr-16 -mt-16 group-hover:bg-indigo-500/5 transition-all"></div>
                                    <div className="w-20 h-20 rounded-[28px] bg-slate-900 text-white flex items-center justify-center shrink-0 shadow-2xl shadow-slate-900/20 group-hover:bg-indigo-600 transition-all">
                                        <Users size={32} />
                                    </div>
                                    <div>
                                        <div className="flex items-center gap-3 mb-2">
                                            <h4 className="text-2xl font-black text-slate-800 tracking-tight">Corps Enseignant</h4>
                                            <span className="px-3 py-1 bg-indigo-50 text-indigo-600 rounded-xl text-[10px] font-black shadow-sm border border-indigo-100">{stats?.teacherCount || 0}</span>
                                        </div>
                                ...
                                <motion.button
                                    ...
                                    className="bg-white rounded-[40px] p-10 border border-slate-100 shadow-xl flex items-center gap-8 text-left hover:border-emerald-200 transition-all group relative overflow-hidden"
                                >
                                    <div className="absolute top-0 right-0 w-40 h-40 bg-indigo-600/5 rounded-full -mr-16 -mt-16 group-hover:bg-emerald-500/5 transition-all"></div>
                                    <div className="w-20 h-20 rounded-[28px] bg-indigo-600 text-white flex items-center justify-center shrink-0 shadow-2xl shadow-indigo-600/20 group-hover:bg-emerald-500 transition-all">
                                        <GraduationCap size={32} />
                                    </div>
                                    <div>
                                        <div className="flex items-center gap-3 mb-2">
                                            <h4 className="text-2xl font-black text-slate-800 tracking-tight">Effectif Élèves</h4>
                                            <span className="px-3 py-1 bg-emerald-50 text-emerald-600 rounded-xl text-[10px] font-black shadow-sm border border-emerald-100">{stats?.studentCount || 0}</span>
                                        </div>
            ...
            {showAddStaffModal && (
                <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 backdrop-blur-xl bg-slate-900/60 animate-in fade-in duration-300">
                    ...
                    >
                        <button onClick={() => { setShowAddStaffModal(false); setEditingStaff(null); setStaffError(null); }} className="absolute top-8 right-8 p-3 bg-slate-50 text-slate-400 rounded-2xl hover:bg-slate-100 transition-all">
                            <X size={20} />
                        </button>
                        ...
                        {staffError && (
                            <div className="mb-6 p-4 bg-red-50 border border-red-100 text-red-600 rounded-2xl text-sm font-bold flex items-center gap-3 animate-in slide-in-from-top-2">
                                <Info size={18} />
                                {staffError}
                            </div>
                        )}
                        ...
                        <form onSubmit={handleAddStaff} className="space-y-6">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 focus:ring-4 focus:ring-indigo-500/10 outline-none font-bold text-slate-700"
                                    />
                                </div>
                                <div className="space-y-2">
                            ...
                            <button
                                type="submit"
                                className="w-full bg-indigo-600 text-white py-5 rounded-[24px] font-black shadow-xl shadow-indigo-600/30 hover:bg-indigo-700 hover:scale-[1.02] active:scale-95 transition-all text-lg"
                            >
                    ...
                    >
                        ...
                        <div className="flex gap-4">
                            ...
                            <button
                                ...
                                className="flex-1 py-4 rounded-[20px] font-black bg-red-500 text-white shadow-xl shadow-red-500/20 hover:bg-red-600 transition-all"
                            >
                                Supprimer
                            </button>
                        </div>
