    ...
    return (
        <>
            <div className="flex flex-col items-center justify-center py-20 text-center">
                <div className="w-24 h-24 bg-blue-50 text-blue-600  flex items-center justify-center mb-8 animate-bounce">
                ...
                <button
                    ...
                    className="mt-10 px-8 py-3 bg-slate-900 text-white  font-bold shadow-xl hover:scale-105 transition-all"
                >
                    Retourner
                </button>
            </div>
