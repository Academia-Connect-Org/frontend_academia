...
const StudentList: React.FC<StudentListProps> = ({ role, institutionId, ceoId }) => {
        ...
        <div className="space-y-6">
                ...
                <div className="flex-1 w-full grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <select
                            ...
                            className="w-full px-5 py-3.5 bg-slate-50    text-sm font-bold text-slate-700 outline-none appearance-none cursor-pointer focus:bg-white focus: disabled:opacity-50"
                        >
            ...
            {showModal && (
                <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
                    <div className="bg-white w-full max-w-3xl ] p-10 shadow-2xl animate-in zoom-in-95 duration-200 relative">
                        <div className="flex justify-between items-center mb-10">
                            ...
                            <button onClick={() => setShowModal(false)} className="w-12 h-12 bg-slate-50 text-slate-400 hover:text-red-500  flex items-center justify-center transition-all hover:bg-red-50"><X size={24} /></button>
                        </div>
                        ...
                        <div className="mt-10 flex gap-4">
                            <button onClick={() => setShowModal(false)} className="flex-1 py-5  font-bold bg-slate-50 text-slate-500 hover:bg-slate-100 transition-all">Abandonner</button>
                            <button
                ...
                <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-white w-full max-w-2xl ] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300  ">
                        <div className="bg-gradient-to-br from-indigo-600 via-indigo-700 to-purple-800 p-10 text-white relative">
                            <button onClick={closePopup} className="absolute top-8 right-8 w-10 h-10 bg-white/10 hover:bg-white/20  flex items-center justify-center transition-all backdrop-blur-md">
                                <X size={20} />
                            </button>
                            <div className="flex items-center gap-8">
                                <div className="w-28 h-28 ] bg-white/10 flex items-center justify-center font-black text-5xl shadow-2xl backdrop-blur-xl   uppercase ring-4 ring-white/10">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <div className="flex flex-wrap gap-2 pt-2">
                                        <span className="flex items-center gap-2 bg-emerald-400/20 text-emerald-300   px-4 py-1.5  text-xs font-black tracking-widest uppercase backdrop-blur-md">
                                            <CheckCircle2 size={12} /> Scolarisé
                                        </span>
                                        <span className="flex items-center gap-2 bg-white/10 px-4 py-1.5  text-xs font-black tracking-widest uppercase backdrop-blur-md">
